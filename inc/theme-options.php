...
if (function_exists('acf_add_options_page')) {
    acf_add_options_page(array(
        'page_title'    => 'Urban Elementor ACF Theme Options',
        'menu_title'    => 'Urban Elementor ACF Theme Options',
        'menu_slug'     => 'urban-elementor-acf-theme-options',
        ...
        'location' => array(
            array(
                array(
                    'param' => 'options_page',
                    'operator' => '==',
                    'value' => 'urban-elementor-acf-theme-options',
                ),
            ),
        ),
    ));
